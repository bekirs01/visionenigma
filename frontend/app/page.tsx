      ...
      <main className="relative max-w-7xl mx-auto px-4 sm:px-6 py-12">
        {!selectedRole ? (
          <div className="text-center mb-12">
            <h2 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mb-6" style={{ lineHeight: '1.3', paddingBottom: '4px' }}>
              {t("welcomeSubtitle")}
            </h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto" style={{ lineHeight: '1.6' }}>
